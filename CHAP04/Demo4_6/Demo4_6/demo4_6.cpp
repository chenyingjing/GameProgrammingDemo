    ...
    case WM_TIMER:
        ...
        switch(wparam)
              ...
              case TIMER_ID1_SEC:
                   ...
                   sprintf_s(buffer,"The 1 second timer has fired %d times",++counter1);
              ...
              case TIMER_ID3_SEC:
                   ...
                   // build up the messages
                   sprintf_s(buffer,"The 3 second timer has fired %d times",++counter2);
            ...
            case TIMER_ID30_SEC:
                   ...
                   // build up the messages
                   sprintf_s(buffer,"The 30 second timer has fired %d times",++counter3);
